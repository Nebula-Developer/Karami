  ...
  var ue = Fe((ae, le) => {
    (function () {
      ...
      (t.Set = function (e) {
        ...
        (t.Set.prototype.intersect = function (
          e
        ) {
          var n,
            r,
      ...
      (t.Pipeline = function () {
        ...
        (t.Pipeline.registeredFunctions =
          Object.create(null)),
        (t.Pipeline.registerFunction = function (
          e,
          n
        ) {
...
`,
        ...
        (t.Pipeline.load = function (e) {
          ...
          return (
            e.forEach(function (r) {
              var i =
                t.Pipeline.registeredFunctions[r];
              if (i) n.add(i);
              else
                throw new Error(
        ...
        (t.Pipeline.prototype.after = function (
          e,
          n
        ) {
          t.Pipeline.warnIfFunctionNotRegistered(
        ...
        (t.Pipeline.prototype.before = function (
          e,
          n
        ) {
          t.Pipeline.warnIfFunctionNotRegistered(
        ...
        (t.Pipeline.prototype.remove = function (
          e
        ) {
        ...
        (t.Pipeline.prototype.runString =
          function (e, n) {
        ...
        (t.Pipeline.prototype.reset =
          function () {
            this._stack = [];
          }),
        (t.Pipeline.prototype.toJSON =
          function () {
      ...
      (t.Vector = function (e) {
        ...
        (t.Vector.prototype.positionForIndex =
          function (e) {
        ...
        (t.Vector.prototype.insert = function (
          e,
          n
        ) {
        ...
        (t.Vector.prototype.upsert = function (
          e,
          n,
          r
        ) {
        ...
        (t.Vector.prototype.similarity =
          function (e) {
            return (
              this.dot(e) / this.magnitude() || 0
            );
          }),
        (t.Vector.prototype.toArray =
          function () {
            for (
              var e = new Array(
      ...
      (t.generateStopWordFilter = function (e) {
        ...
        return function (r) {
          if (
            r &&
            n[r.toString()] !== r.toString()
          )
            return r;
        };
      }),
        (t.stopWordFilter =
          t.generateStopWordFilter([
            'a',
            'able',
            'about',
            'across',
      ...
      (t.TokenSet = function () {
        ...
        (t.TokenSet.fromClause = function (e) {
          return 'editDistance' in e
            ? t.TokenSet.fromFuzzyString(
                e.term,
                e.editDistance
              )
            : t.TokenSet.fromString(e.term);
        }),
        (t.TokenSet.fromFuzzyString = function (
          e,
          n
        ) {
          for (
        ...
        (t.TokenSet.prototype.intersect =
          function (e) {
            for (
              var n = new t.TokenSet(),
                r = void 0,
        ...
        (t.TokenSet.Builder.prototype.insert =
          function (e) {
            var n,
              r = 0;
        ...
        (t.TokenSet.Builder.prototype.finish =
          function () {
            this.minimize(0);
          }),
        (t.TokenSet.Builder.prototype.minimize =
          function (e) {
            for (
              var n =
              ...
              i in this.minimizedNodes
                ? (r.parent.edges[r.char] =
                    this.minimizedNodes[i])
                : ((r.child._str = i),
                  (this.minimizedNodes[i] =
                    r.child)),
      ...
      (t.Builder = function () {
        ...
        (t.Builder.prototype.field = function (
          e,
          n
        ) {
          if (/\//.test(e))
        ...
        (t.Builder.prototype.add = function (
          e,
          n
        ) {
          var r = e[this._ref],
        ...
        (t.Builder.prototype.createFieldVectors =
          function () {
            for (
              var e = {},
                n = Object.keys(
              ...
              for (
                var o = t.FieldRef.fromString(
                  ...
                  u = new t.Vector(),
                  d =
                    this.fieldTermFrequencies[o],
                  m = Object.keys(d),
                  p = m.length,
                  b = this._fields[a].boost || 1,
                  g =
                    this._documents[o.docRef]
                      .boost || 1,
                  L = 0;
                L < p;
                L++
        ...
        (t.Builder.prototype.createTokenSet =
          function () {
        ...
        (t.MatchData.prototype.combine =
          function (e) {
            for (
              var n = Object.keys(e.metadata),
                r = 0;
              r < n.length;
              r++
            ) {
        ...
        (t.MatchData.prototype.add = function (
          e,
          n,
          r
        ) {
        ...
        (t.Query.prototype.clause = function (e) {
          return (
            'fields' in e ||
              (e.fields = this.allFields),
            'boost' in e || (e.boost = 1),
            'usePipeline' in e ||
              (e.usePipeline = !0),
            'wildcard' in e ||
              (e.wildcard =
                t.Query.wildcard.NONE),
            e.wildcard &
              t.Query.wildcard.LEADING &&
              e.term.charAt(0) !=
                t.Query.wildcard &&
              (e.term = '*' + e.term),
            e.wildcard &
              t.Query.wildcard.TRAILING &&
              e.term.slice(-1) !=
                t.Query.wildcard &&
              (e.term = '' + e.term + '*'),
            'presence' in e ||
              (e.presence =
                t.Query.presence.OPTIONAL),
            this.clauses.push(e),
            this
          );
        }),
        (t.Query.prototype.isNegated =
          function () {
            for (
              var e = 0;
              e < this.clauses.length;
              e++
            )
              if (
        ...
        (t.Query.prototype.term = function (
          e,
          n
        ) {
          if (Array.isArray(e))
        ...
        (t.QueryLexer.prototype.run =
          function () {
            for (
              var e = t.QueryLexer.lexText;
              e;

            )
              e = e(this);
          }),
        (t.QueryLexer.prototype.sliceString =
          function () {
            for (
              var e = [],
                n = this.start,
        ...
        (t.QueryLexer.prototype.emit = function (
          e
        ) {
          this.lexemes.push({
            type: e,
        ...
        (t.QueryLexer.prototype.escapeCharacter =
          function () {
            this.escapeCharPositions.push(
              this.pos - 1
            ),
              (this.pos += 1);
          }),
        (t.QueryLexer.prototype.next =
          function () {
        ...
        (t.QueryLexer.prototype.width =
          function () {
            return this.pos - this.start;
          }),
        (t.QueryLexer.prototype.ignore =
          function () {
            this.start == this.pos &&
              (this.pos += 1),
              (this.start = this.pos);
          }),
        (t.QueryLexer.prototype.backup =
          function () {
            this.pos -= 1;
          }),
        (t.QueryLexer.prototype.acceptDigitRun =
          function () {
            var e, n;
            do
              (e = this.next()),
        ...
        (t.QueryLexer.lexEditDistance = function (
          e
        ) {
          return (
            e.ignore(),
        ...
        (t.QueryLexer.termSeparator =
          t.tokenizer.separator),
        (t.QueryLexer.lexText = function (e) {
          for (;;) {
            ...
            if (
              n.match(t.QueryLexer.termSeparator)
            )
        ...
        (t.QueryParser.prototype.parse =
          function () {
            this.lexer.run(),
              (this.lexemes = this.lexer.lexemes);
            for (
              var e = t.QueryParser.parseClause;
              e;
        ...
        (t.QueryParser.prototype.peekLexeme =
          function () {
            return this.lexemes[this.lexemeIdx];
          }),
        (t.QueryParser.prototype.consumeLexeme =
          function () {
            var e = this.peekLexeme();
            return (this.lexemeIdx += 1), e;
          }),
        (t.QueryParser.prototype.nextClause =
          function () {
            var e = this.currentClause;
            this.query.clause(e),
              (this.currentClause = {});
          }),
        (t.QueryParser.parseClause = function (
          e
        ) {
          var n = e.peekLexeme();
          if (n != null)
        ...
        (t.QueryParser.parsePresence = function (
          e
        ) {
        ...
        (t.QueryParser.parseField = function (e) {
          ...
          if (n != null) {
            if (
              e.query.allFields.indexOf(n.str) ==
              -1
            ) {
        ...
        (t.QueryParser.parseTerm = function (e) {
          var n = e.consumeLexeme();
          if (n != null) {
            (e.currentClause.term =
              n.str.toLowerCase()),
              n.str.indexOf('*') != -1 &&
                (e.currentClause.usePipeline =
                  !1);
            var r = e.peekLexeme();
            if (r == null) {
              e.nextClause();
        ...
        (t.QueryParser.parseEditDistance =
          function (e) {
            var n = e.consumeLexeme();
            if (n != null) {
  ...
  var U = class {
    ...
    createComponents(e) {
      se.forEach((n) => {
        e.querySelectorAll(n.selector).forEach(
          (r) => {
    ...
    ensureActivePageVisible() {
      ...
      for (
        ;
        n &&
        !n.classList.contains('.tsd-navigation');
    ...
    ensureFocusedElementVisible() {
      ...
      if (n.offsetParent == null) {
        ...
        s.classList.add('warning'),
          (s.textContent =
            window.translations.normally_hidden),
          n.prepend(s);
      }
      r && e.scrollIntoView();
    }
      ...
      document
        ...
        .forEach((e) => {
          ...
          e.addEventListener('click', () => {
            e.previousElementSibling instanceof
              HTMLElement &&
  ...
  function Ne(t, e, n, r) {
    ...
    for (
      let o = 0, a = Math.min(10, s.length);
      o < a;
      o++
    ) {
  ...
  function Be(t, e) {
    ...
    if (
      (n ||
        (n = t.querySelector('li:first-child')),
      n)
    ) {
  ...
  document.addEventListener(F, (t) => {
    (ne = !0), (D = !1);
    let e =
      F == 'touchstart' ? t.targetTouches[0] : t;
  ...
  var X = class extends I {
    constructor(e) {
      super(e),
        (this.className =
          this.el.dataset.toggle || ''),
        this.el.addEventListener(N, (n) =>
          this.onPointerUp(n)
        ),
    ...
    onPointerUp(e) {
      D ||
        (this.setActive(!0), e.preventDefault());
    }
  ...
  var Q = re;
  var ge = document.head.appendChild(
...
`),
  ...
  var Z = class extends I {
    constructor(e) {
      super(e),
        ...
        (this.icon =
          this.summary.querySelector('svg')),
  ...
  async function Le() {
    ...
    let n = await (
        await fetch(window.navigationData)
      ).arrayBuffer(),
      r = new Blob([n])
        .stream()
        .pipeThrough(
